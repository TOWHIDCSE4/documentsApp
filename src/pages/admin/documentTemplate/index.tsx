...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        return (
          <div style={checkStatusColor(text)}>{checkStatusByName(text)}</div>
        );
      },
    },
    {
      ...
      render: (text, record) => {
        return (
          <Space size="middle">
            ...
            <span title="Download CSV" style={{ cursor: "pointer" }}>
          ...
          {statusCount && (
            <div>
              <ButtonGroup>
                ...
                <Button
                  onClick={() =>
                    console.log("To Be Reviewed button is clicked")
                  }
                >
                  <Badge
                ...
                <Button
                  onClick={() => console.log("Rejected button is clicked")}
                >
                  <Badge
