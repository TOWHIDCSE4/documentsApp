    ...
    <>
      <Row gutter={16}>
        <Col span={12}>
          <Card
            type="inner"
            title="Form List"
            onClick={() => redirect("frontend.admin.documentTemplate")}
      ...
      <Card>
        <Row justify="space-between">
          ...
          >
            <Meta
              title="Staff Insurance 2022"
              description="Staff Insurance 2022 is dedicated to tenants & worker."
            />
            <br />
            <Button
              type="primary"
              onClick={() => redirect("frontend.admin.application.create")}
            >
          ...
          <Card
            ...
            cover={
              <img
                alt="anh-nen"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU9R3q8guKFAt-fsNfc_7AN6a_o9tQxsAGXnbPDNbuvndQfusFQRHl3wCLAzGRIL0Pr_M&usqp=CAU"
              />
            }
          >
            <Meta
              title="2022 Water Rebate"
